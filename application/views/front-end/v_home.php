  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 d-flex flex-column justify-content-center">
        ...
        <h2 data-aos="fade-up" data-aos-delay="400">Gas 3kg ada, 5,5kg ada, 12kg ada, 50kg pun ada, apa yang takde.....</h2>
     ...
     <!--<div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200">
        <img src="<?= base_url(); ?>vendor/front-end/assets/img/DJI_0032.jpg" class="img-fluid" alt="">
      </div>-->      
    </div>
  </div>
...
<section id="certificate" class="certificate section-bg">
    <div class="container">
      <div class="row" data-aos="zoom-in">
        <div class="col-lg-2 col-xs-2 col-3 d-flex align-items-center justify-content-center" style="max-width:14%;">
          <img src="<?= base_url(); ?>vendor/front-end/assets/img/asa/certificate/Sertificate_SNI Katup Wajib.jpg" class="img-fluid" alt="SNI Katup Wajib">
        </div>
        <div class="col-lg-2 col-xs-2 col-3 d-flex align-items-center justify-content-center" style="max-width:14%;">
          <img src="<?= base_url(); ?>vendor/front-end/assets/img/asa/certificate/Sertificate_SNI Tabung Wajib.jpg" class="img-fluid" alt="SNI Tabung Wajib">
        </div>
        <div class="col-lg-2 col-xs-2 col-3 d-flex align-items-center justify-content-center" style="max-width:14%;">
          <img src="<?= base_url(); ?>vendor/front-end/assets/img/asa/certificate/Sertificate_SNI Katup Sukarela.jpg" class="img-fluid" alt="SNI Katup Sukarela">
        </div>
        <div class="col-lg-2 col-xs-2 col-3 d-flex align-items-center justify-content-center" style="max-width:14%;">
          <img src="<?= base_url(); ?>vendor/front-end/assets/img/asa/certificate/Sertificate_LSSM BSI.jpg" class="img-fluid" alt="LSSM BSI">
        </div>
        <div class="col-lg-2 col-xs-2 col-3 d-flex align-items-center justify-content-center" style="max-width:14%;">
          <img src="<?= base_url(); ?>vendor/front-end/assets/img/asa/certificate/Sertificate_LSPr BSI.jpg" class="img-fluid" alt="LSPr BSI">
        </div>
        <div class="col-lg-2 col-xs-2 col-3 d-flex align-items-center justify-content-center" style="max-width:14%;">
          <img src="<?= base_url(); ?>vendor/front-end/assets/img/asa/certificate/sertifikat4.png" class="img-fluid" alt="LSPr BSI">
        </div>
        <div class="col-lg-2 col-xs-2 col-3 d-flex align-items-center justify-content-center" style="max-width:14%;">
          <img src="<?= base_url(); ?>vendor/front-end/assets/img/asa/certificate/sertifikat5.png" class="img-fluid" alt="LSPr BSI">
        </div>
</section>
<!-- ======= End certificate ======= -->
    ...
    <header class="section-header">
      ...
      <div class="row gx-0">
        ...
        <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
          <div class="content card" style="padding:64px;">
            <h3>PT. ASA BINTANG PRATAMA</h3>
            <p><?=$setting->profile?></p>
            <div class="text-center text-lg-start">
        ...
        <div class="col-lg-6 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="200">
          <img style="height:90%;width:100%;padding:30px;" src="<?= base_url(); ?>vendor/front-end/assets/img/asa/gallery/tabung/EIMG_7766.jpg" class="img-fluid" alt="">
        </div>
    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row" style="width:100%;height:50%;">
        ...
        <div class="col-lg-12" data-aos="zoom-out" data-aos-delay="200">
          <img style="height:90%;width:100%;" src="<?= base_url(); ?>vendor/front-end/assets/img/asa/gallery/valve/DJI_0032.jpg" class="img-fluid" alt="">
        </div>
      ...
      <!-- Feature Tabs -->
      <div class="row align-tabs" data-aos="fade-up">
        <div class="col-lg-12">
          ...
          <div class="tab-content">
            ...
            <div class="card tab-pane fade show" id="tab2">
              <p class=""><?= $setting->misi; ?></p>
            </div><!-- End Tab 2 Content -->

            <div class="card tab-pane fade show" id="tab3">
        ...
        <!--<div class="col-lg-6" >
          <img style="padding:100px;" src="<?= base_url(); ?>vendor/front-end/assets/img/EIMG_7975.jpg" class="img-fluid" alt="">
        </div>-->
          ...
          if ($value->status_layanan == "Publish") : ?>
            <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="200">
              <div class="service-box blue">
                <div class="post-img"> <img src="<?= base_url('assets/img/layanan/') . $value->gambar_layanan; ?>" alt="" class="img-fluid rounded " style="height: 200px; width:300px;">
                </div>
